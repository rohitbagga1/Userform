    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">Please fill the following form with required details.</p>
                <form id="myform">
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <div class="col-12">
                                <input required type="text" name="firstname" class="form-control" maxlength="20"
                                    id="firstname">
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            ...
                            <div class="col-12">
                                <input required type="text" name="lastname" class="form-control" maxlength="20"
                                    id="lastname">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="inputPassword" class="col-form-label">Select Country Code</label>
                            <div class="col">
                                <select required class="form-control" name="countryCode" id="countryCode">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col">
                                <input required type="tel" name="phonenumber" maxlength="10" number class="form-control"
                                    id="phonenumber">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col">
                                <input required type="password" name="password" class="form-control" id="pass">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="inputPassword" class="col-form-label">Confirm Password</label>
                            <div class="col">
                                <input required type="password" name="confirmpassword" class="form-control" id="cpass">
                            </div>
                        </div>
                        <div class="submit">
                            <button type="submit" class="col-3 btn ">Submit</button>
                        </div>
                    </div>
            </div>
            </form>
...
function saveUserdata() {
    ...
    $.post("handel-ajax-userformstore.php", {
        firstname: firstname,
        lastname: lastname,
        email: email,
        pass: pass,
